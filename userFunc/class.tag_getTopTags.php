 ...
 */
class tag_getTopTags extends user_getTopTags {

	/**
	 * The template marker's name for the class
	 */
	protected $templateMarkerChartClass = '###TEMPLATE_TAG_tag.getTopTags_TR_CLASS-effect###';
	/**
	 * The template marker's name for the width
	 */
	protected $templateMarkerChartWidth = '###TEMPLATE_TAG_tag.getTopTags_DIV_WIDTH###';
}
